...
import SaveTradeSettingService from '../services/TradeSettingService';
class TradeSettingComponent extends React.Component{
    ...
    fetchcashFlowService = () => {
        SaveTradeSettingService.getSetting(null,(response) => {
    ...
    render() {
        return(
            <React.Fragment>
                <Header {...this.props}/>
                <Form
                    service={SaveTradeSettingService.saveSetting}
                    {...this.props}
                    {...this.state}
