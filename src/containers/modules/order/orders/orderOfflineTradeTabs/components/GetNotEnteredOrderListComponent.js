   ...
   ${excelAndPdfToolbar}`,
      ...
      dataBound: function (e) {
        ...
        if (this.dataSource.data().length > 0) {
          ...
          $("#not-entered-orders tbody tr td span.edit").on("click", function (item) {
          ...
          $("#not-entered-orders tbody tr td span.delete").on("click", function (item) {
            var grid = $("#not-entered-orders").data("kendoGrid");
            var row = $(item.target).closest("tr");
            var dataItem = grid.dataItem(row);
          ...
          $("#not-entered-orders tbody tr td span.assignToBranch").on("click", function (item) {
            var grid = $("#not-entered-orders").data("kendoGrid");
            var row = $(item.target).closest("tr");
            var dataItem = grid.dataItem(row);
