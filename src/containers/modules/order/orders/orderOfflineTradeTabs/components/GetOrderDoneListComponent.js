   ...
   ${excelAndPdfToolbar}`,
      ...
      dataBound: function (e) {
        ...
        if (this.dataSource.data().length > 0) {
          ...
          $("#done-orders tbody tr td span.edit").on("click", function (item) {
          ...
          $("#done-orders tbody tr td span.delete").on("click", function (item) {
            var grid = $("#done-orders").data("kendoGrid");
            var row = $(item.target).closest("tr");
            var dataItem = grid.dataItem(row);
          ...
          $("#done-orders tbody tr td span.assignToBranch").on("click", function (item) {
            var grid = $("#done-orders").data("kendoGrid");
            var row = $(item.target).closest("tr");
            var dataItem = grid.dataItem(row);
