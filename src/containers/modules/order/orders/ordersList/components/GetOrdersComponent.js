...
class GetOrders extends React.Component {
  ...
  search() {
    ...
    // $("#orders-list").data("kendoGrid").refresh();
    $("#orders-list").data("kendoGrid").dataSource.read(this);
    // console.log("orders-list",$("#orders-list").data("kendoGrid").content.scrollLeft());
  };
      ...
      dataSource: {
        transport: {
          read: function (option) {
            ...
            console.log("requestCancel", self.state.requestCancel);
            var command = {
              reportFilter: {
