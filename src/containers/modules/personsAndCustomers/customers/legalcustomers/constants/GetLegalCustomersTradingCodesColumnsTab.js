    ...
    return [
        ...
        },
        {
            ...
            cell: (event) => {
                ...
                console.log('props عملیات',props);
                return (
                    <td>
                        <Delete deleteService={CustomerTradingCodesService.deletePartyMethod} info={event.dataItem} entity={event.dataItem.partyId}  {...props}  fullName={event.dataItem.fullName}/>
