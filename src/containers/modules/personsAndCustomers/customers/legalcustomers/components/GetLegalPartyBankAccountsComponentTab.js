...
class GetLegalPartyBankAccountsComponentTab extends React.Component {
    ...
    add = () => {
        ...
        this.props.history.push(
            {
              pathname: this.props.addInGridPartyBankAccountLegal.path,
              state: {
    ...
    edit = (v) => {
        this.props.history.push(
            {
              pathname: this.props.editInGridPartyBankAccountLegal.path,
              state: {
                  id: v,
                  backPath : "/main/persons/customers/completeRegisterLegal",
                //   title:"تکمیل فرم مشتریان",
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Paper className={"main-paper-container legal-party-bank-account-managed-realCustomer-tab"}>
