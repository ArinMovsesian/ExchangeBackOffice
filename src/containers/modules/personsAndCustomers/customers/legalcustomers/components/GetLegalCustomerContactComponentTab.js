...
class GetLegalCustomerContactComponentTab extends React.Component {
    ...
    add = () =>{
        ...
        this.props.history.push(
            {
              pathname: this.props.addInGridCustomerContactLegal.path,
              state: {
    ...
    edit = (v) => {
        ...
        this.props.history.push(
            {
              pathname: this.props.editInGridCustomerContactLegal.path,
              state: {
                  id: v,
                  backPath : "/main/persons/customers/completeRegisterLegal",
                //   title:"تکمیل فرم مشتریان",
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Paper className={"main-paper-container managed-legal-customer-contact-tab"}>
