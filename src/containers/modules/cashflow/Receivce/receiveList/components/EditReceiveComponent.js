...
class EditReceiveComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log('EditReceive',this.props.history.location.state.sateParams.id);
        GetAllCashFlowCategoryService.getreceivebyidMethod({
            "entity": this.props.history.location.state.sateParams.id,
        }, (response) => {
            ...
            console.log('getreceivebyidMethod', response);
            this.setState({
                ...
                GetAllCashFlowCategoryService.getAllCashFlowCategoryMethod(null, (response) => {
                    for(let i = 0  ; i < response.result.length; i++){
                        if(this.state.cashFlowCategoryTitle === response.result[i].title){
                            console.log('r',response.result[i]);
                            this.setState({
    ...
    render() {
        // console.log('DATE', this.state.date, moment(this.state.date).locale('en').format('jYYYY/jMM/jDD'));
                    ...
                    <Fieldset legend={'اطلاعات فردی'}>
                        ...
                        <Grid container spacing={8} className="no-margin">
                            <Grid item md={3}>
                                ...
                                {/* <PersianDatePicker selectedDate={this.state.date} label="تاریخ فیش" handleOnChange={(value) => this.handleDate(value, 'date')}/> */}
                            </Grid>
                        </Grid>
                        <Grid container spacing={8} className="no-margin">
                            <Grid item md={3}>
